        ...
        <div className="flex items-center gap-4 p-4 border-b border-slate-100 dark:border-slate-700">
          ...
          <div className="relative" ref={statusDropdownRef}>
            <button
              ...
              className={`badge ${statusColors[conversation.status]} cursor-pointer hover:opacity-80 flex items-center gap-1`}
            >
              {conversation.status}
            ...
            {showStatusDropdown && (
              <div className="absolute right-0 top-8 w-36 bg-white dark:bg-slate-800 rounded-xl shadow-xl border border-slate-200 dark:border-slate-700 py-1 z-50">
